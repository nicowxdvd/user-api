...
export class UserProfileRepository implements IUserProfileRepository {
  ...
  constructor(@InjectRepository(UserProfile) private readonly typeormRepo: Repository<UserProfile>) {}
  ...
  async update(id: number, userProfile: Partial<UserProfile>): Promise<UserProfile | null> {
